...
export const Content = styled.TextInput`
  font-size: 14px;
  padding: ${(props) => (Platform.OS === 'ios' ? props.theme.spacing.sm : props.theme.spacing.md)}px;
...
export const AbsoluteIcon = styled.View`
  position: absolute;
  left: ${(props) => (Platform.OS === 'ios' ? props.theme.spacing.sm : props.theme.spacing.md)}px;
`;

export const AbsoluteLoading = styled.View`
  position: absolute;
  right: ${(props) => (Platform.OS === 'ios' ? props.theme.spacing.sm : props.theme.spacing.md)}px;
`;
